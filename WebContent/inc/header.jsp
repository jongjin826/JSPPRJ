	...
	<div class="content-wrapper">
		<h1 id="logo">
			<a href="${ctxName}/index.jsp"><img
				src="${ctxName}/images/logo.png" alt="뉴렉처 온라인" /></a>
		</h1>
			...
			<nav id="member-menu">
				...
				<ul class="clearfix">
					...
					<li class="member-menu-item"><c:if test="${uid == null}">
							<a class="member-menu-item-text"
								href="${ctxName}/joinus/login.jsp">로그인</a>
						</c:if> <c:if test="${uid != null}">
							<a class="member-menu-item-text"
								href="${ctxName}/joinus/logoutProc.jsp">로그아웃</a>
						</c:if></li>
					<li class="member-menu-item"><a class="member-menu-item-text"
			...
			<nav id="my-menu">
				...
				<ul class="clearfix">
					...
					<li class="my-menu-item"><a class="my-menu-item-text"
						href="${ctxName}/customer/notice.jsp"><img
							src="${ctxName}/images/txt-customer.png" alt="고객센터" /></a></li>
				</ul>
			</nav>
		</section>
	</div>
